...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 develop
  WORKING_DIRECTORY "C:/Users/ndiapa01/Desktop/documentation_generation/build/_deps/toolchains-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'http://bitbucket.srl4417r.hq001.corp.sfy/scm/~faurad01/cmake_toolchains.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ndiapa01/Desktop/documentation_generation/build/_deps/toolchains-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ndiapa01/Desktop/documentation_generation/build/_deps/toolchains-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
